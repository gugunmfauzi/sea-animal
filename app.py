...
st.set_page_config(page_title="Pengenalan Gambar Sea Animal")
...
<h5 style="color: white;">Deteksi Gambar Sea Animal</h5>
</div>
...
if cek_library():
    # upload gambar
     uploaded_file = st.file_uploader("upload gambar Sea Animal", type=['jpg', 'jpeg', 'png'])
